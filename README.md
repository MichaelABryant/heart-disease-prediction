...
This repository is for the analysis and modeling done with the UCI heart disease dataset. Below you will find an overview of the data, code, and results. Diagnosing heart attacks (i.e., angina caused by heart disease) has a misdiagnosis rate of 33%. This translates to a recall score of 66% which I considered the baseline for a successful model. The test set recall score for my best performing models were 93% and 90%. Therefore, the project was a sucess.
